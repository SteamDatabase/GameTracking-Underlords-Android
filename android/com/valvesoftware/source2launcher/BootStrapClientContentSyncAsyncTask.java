...
public class BootStrapClientContentSyncAsyncTask extends IContentSyncAsyncTask {
    ...
    private boolean SyncContent() {
        ...
        if (!z) {
            ...
            z9 = BootStrapClient.DownloadDirectory(iStreamingBootStrap11, sb24, sb25.toString(), true, 60000, recursiveDownloadExtensionExlusionAndRelativeDirectoryFilter2) && z11;
