...
public interface IStreamingBootStrap {
    ...
    public static class StaticHelpers {
        ...
        public static void CaughtExternalCodeException(Throwable th) {
            Log.i("com.valvesoftware.IStreamingBootStrap", "External code exception \"" + th.getMessage() + "\"");
            th.printStackTrace();
        }
    ...
    public static class IRequestHandler_Tunnel {
        ...
        /*  JADX ERROR: JadxRuntimeException in pass: SimplifyVisitor
            jadx.core.utils.exceptions.JadxRuntimeException: Don't wrap MOVE or CONST insns: 0x0058: MOVE  (r5v2 long[]) = (r22v0 long[])
        ...
        public static int DecodeListenRequestResponse(byte[] bArr, int i, int i2, IListenRequestResponseCallback iListenRequestResponseCallback) {
            ...
            do {
                ...
                if (b == 0) {
                    ...
                    i5 += DecodeUVarInt2;
                    iListenRequestResponseCallback.OnListenRequestResponse(j, true, jArr[0], (String) null);
                } else {
                    if (b > 1) {
    ...
    public static abstract class CEmbeddedIOImpl_Base extends IStreamingBootStrapIOImpl {
        ...
        public long ReadData(byte[] bArr, int i) {
            ...
            return (long) this.m_ReceiveStream.ReadBufferedData(bArr, i, (int[]) null);
        }
    }
